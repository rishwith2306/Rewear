        ...
        <div className="grid md:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <ul className="space-y-2 text-gray-400">
              <li>
                <Link href="/browse">
                  <span className="hover:text-white transition-colors cursor-pointer">Browse Items</span>
                </Link>
              </li>
              <li>
                <Link href="/sell">
                  <span className="hover:text-white transition-colors cursor-pointer">Sell Items</span>
                </Link>
              </li>
              <li>
              ...
              <li>
                <a href="#" className="hover:text-white transition-colors">Featured</a>
              </li>
            </ul>
          </div>
